        ...
        <section class="my-5">
            ...
            <div class="card shadow" id="vueapp">
                ...
                <div class="card-header d-flex">
                    <h5>مدیریت برندها</h5>
                    <a href="{{route('admin.brand.create')}}" class="btn btn-sm btn-primary me-auto">افزودن رکورد</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr v-for="(item, index) in models" :key="index">
                            ...
                            <td class="actions-btns d-inline">
                                ...
                                <a :href="`{{$base_url}}/brand/${item.id}/edit`" target="_blank"
        ...
        createApp({
            ...
            methods:{
                async restoreItem(id, index){
                    ...
                    fetch("{{$base_url}}/restore-brand/" + id, {
                        headers: {
